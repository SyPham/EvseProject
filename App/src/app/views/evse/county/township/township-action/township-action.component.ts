...
import { Township, County } from 'src/app/_core/_model/evse/model';
import { TownshipService } from 'src/app/_core/_service/evse/township.service';
import { environment } from 'src/environments/environment';
declare let $: any;

@Component({
  selector: 'app-township-action',
  templateUrl: './township-action.component.html',
  styleUrls: ['./township-action.component.css']
})
export class TownshipActionComponent   extends BaseComponent implements OnInit {
  @Input() title: string = "Township_Detail";
  ...
  initModel() {
    this.model = {} as Township;
    this.model.countyId = this.county.countyId;
