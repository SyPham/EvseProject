...
@Component({
  ...
  styleUrls: ['./favorite-action.component.css']
})
export class FavoriteActionComponent extends BaseComponent implements OnInit {
  @Input() title: string = "Favorite_Detail";
