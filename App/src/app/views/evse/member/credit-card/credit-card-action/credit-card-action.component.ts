...
@Component({
  selector: 'app-credit-card-action',
  templateUrl: './credit-card-action.component.html',
  styleUrls: ['./credit-card-action.component.css']
})
export class CreditCardActionComponent  extends BaseComponent implements OnInit {
  @Input() title: string = "CreditCard_Detail";
