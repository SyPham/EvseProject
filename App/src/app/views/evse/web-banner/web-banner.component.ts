...
import { BaseComponent, UtilitiesService } from '@pigfarm-core';
import { TranslateService } from '@ngx-translate/core';
import { ActivatedRoute } from '@angular/router';
import { environment } from 'src/environments/environment';
import { DatePipe } from '@angular/common';
import { WebBanner } from 'src/app/_core/_model/evse/model';
...
export class WebBannerComponent extends BaseComponent implements OnInit {
  isAdmin = JSON.parse(localStorage.getItem('user'))?.groupCode === 'ADMIN_CANCEL';
  data: DataManager;
  modalReference: NgbModalRef;
  active = "Detail"
  @ViewChild('grid') public grid: GridComponent;
  model: WebBanner = {} as WebBanner;
  ...
  constructor(
    private service: WebBannerService,
  ...
  loadData() {
    ...
    this.data = new DataManager({
      url: `${this.baseUrl}WebBanner/LoadData?lang=${lang}`,
