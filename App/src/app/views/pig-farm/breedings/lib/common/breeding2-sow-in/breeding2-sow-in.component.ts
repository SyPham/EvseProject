...
@Component({
  selector: "pigfarm-breeding2-sow-in2",
  templateUrl: "./breeding2-sow-in.component.html",
  styleUrls: ["./breeding2-sow-in.component.css"],
  providers: [EditService,CommandColumnService, DatePipe],
})
export class Breeding2SowIn2Component
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  @Input() allowEditingParity = true;
  @Input() visibleMatingDate = true;
  @Input() visibleHeatingResult = true;
