...
import { BomBoarRoutingModule } from './bom-boar.routing.module';
import { BomBoarDetailComponent } from './bom-boar-detail/bom-boar-detail.component';
