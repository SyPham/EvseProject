...
export class EmployeeComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    public xaccountGroupService: XAccountGroupService,
  ) {
...
toolbarClick(args) {
  ...
  actionBegin(args) {
    ...
    if (args.requestType === 'save' && args.action === 'add') {
      ...
      if (args.data.nickName === undefined) {
        this.alertify.error(this.translate.instant('Please key in a nickName!'));
        args.cancel = true;
        return;
      }
      if (args.data.no === undefined) {
        this.alertify.error(this.translate.instant('Please key in a NO!'));
        args.cancel = true;
        return;
      }
      if (args.data.name === undefined) {
        this.alertify.error(this.translate.instant('Please key in a name!'));
        args.cancel = true;
        return;
      }
  ...
  save() {
    if (this.model.id > 0) {
      ...
      this.alert.yes_message,
      this.alert.no_message,
      this.translate.instant('Update record'),
      this.translate.instant('Are you sure you want to update this record?'),
        () => {
      ...
      this.alert.yes_message,
      this.alert.no_message,
      this.translate.instant('Add record'),
      this.translate.instant('Are you sure you want to add this record?'),
        () => {
