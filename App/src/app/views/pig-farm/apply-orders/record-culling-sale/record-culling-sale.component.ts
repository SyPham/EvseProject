...
import { RecordMarketModalComponent } from '../record-sale/record-market-modal/record-market-modal.component';
  ...
  implements OnInit, OnDestroy
{
  ...
  disabledInput(date : any) {
    ...
    constructor(
      public service: RecordCullingSaleService,
...
private router: Router,
  ...
  loadRoomGuid() {
    return this.serviceRoom
      .getRoomByRecord(this.model?.guid || "", "Record_CullingSale")
      .toPromise();
  }
  async loadPen() {
 ...
 async loadPig() {
  ...
  loadButtonConfig() {
    ...
    let predicate: Predicate = new Predicate("type", "equal", "Record_CullingSale");
  ...
  loadConfig() {
    let query = new Query();
    query.where("type", "equal", "Record_CullingSale");
  ...
  getCheckedPigData() {
    this.servicePig
      .getSelectedPigsByRecord(this.model?.guid, "Record_CullingSale")
      .subscribe((data: any) => {
