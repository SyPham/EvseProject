...
private router: Router,
  ...
  // life cycle ejs-grid
    ...
    transferCalculate() {
      this.service
      .transferCalculate(this.model.guid,this.model.inOutQty,this.model.inOutWeight, this.model.transferType)
      .pipe(
        switchMap(() => this.service.getById(this.model.id) )
      )
      .subscribe(item => {
        if (item.inOutAmount) {
          this.alertify.success(this.alert.updated_ok_msg);
          this.model.inOutAmount = item.inOutAmount;
        }
      });
    }
