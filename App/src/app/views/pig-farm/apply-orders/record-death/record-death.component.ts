...
import { Header, RecordDeath  } from "src/app/_core/_model/apply-orders";
...
private router: Router,
  ...
  estDate: any;
    ...
    demoConfigHeaderAndData() {
      this.service.demoConfigHeaderAndData().subscribe(data => {
        this.headers = Header.getHeaders(data)
        this.data2 = Header.skip(data, 3)
      })
    }
