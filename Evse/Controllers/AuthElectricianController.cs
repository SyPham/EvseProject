...
{
    public class AuthElectricianController : ApiControllerBase
    {
        private readonly IAuthElectricianService _authService;

        public AuthElectricianController(
            IAuthElectricianService authService
            )
        {
