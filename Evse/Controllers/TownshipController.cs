...
{
    public class TownshipController : ApiControllerBase
    {
        private readonly ITownshipService _service;

        public TownshipController(ITownshipService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] TownshipDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] TownshipDto model)
        {
