...
{
    public class AccountContractController : ApiControllerBase
    {
        private readonly IAccountContractService _service;

        public AccountContractController(IAccountContractService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] AccountContractDto model)
        {
            return StatusCodeResult(await _service.AddAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateAsync([FromBody] AccountContractDto model)
        {
  ...
  [HttpPost]
    ...
    [HttpPost]
        public async Task<ActionResult> AddFormAsync([FromForm] AccountContractDto model)
        {
            return Ok(await _service.AddFormAsync(model));
        }

        [HttpPut]
        public async Task<ActionResult> UpdateFormAsync([FromForm] AccountContractDto model)
        {
