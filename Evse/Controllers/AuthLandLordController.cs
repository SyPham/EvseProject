...
{
    public class AuthLandLordController : ApiControllerBase
    {
        private readonly IAuthLandLordService _authService;

        public AuthLandLordController(
            IAuthLandLordService authService
            )
        {
